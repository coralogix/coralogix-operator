...
<table>
    ...
    <tbody><tr>
      ...
      <td>true</td>
        ...
        <td><b><a href="#aievaluationspec">spec</a></b></td>
        <td>object</td>
        <td>
          AIEvaluationSpec defines the desired state of AIEvaluation.<br/>
        </td>
        <td>false</td>
      </tr><tr>
        <td><b><a href="#aievaluationstatus">status</a></b></td>
        <td>object</td>
        <td>
          AIEvaluationStatus defines the observed state of AIEvaluation.<br/>
        </td>
        <td>false</td>
      </tr></tbody>
</table>
...
### AIEvaluation.spec
<sup><sup>[↩ Parent](#aievaluation)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td>string</td>
        <td>
          Name of the AI application this evaluation belongs to.<br/>
          <br/>
            <i>Validations</i>:<li>self == oldSelf: spec.application is immutable</li>
        </td>
        <td>true</td>
      </tr><tr>
        <td><b><a href="#aievaluationspecconfig">config</a></b></td>
        <td>object</td>
        <td>
        ...
        <td>string</td>
        <td>
          Subsystem within the application.<br/>
          <br/>
            <i>Validations</i>:<li>self == oldSelf: spec.subsystem is immutable</li>
        </td>
        <td>true</td>
      </tr><tr>
        <td><b>target</b></td>
        <td>enum</td>
        <td>
          Target span content the evaluation runs against.<br/>
          <br/>
            <i>Validations</i>:<li>self == oldSelf: spec.target is immutable</li>
            <i>Enum</i>: prompt, response<br/>
        </td>
        <td>true</td>
      </tr><tr>
        <td><b>threshold</b></td>
...
Fractional values must be supplied as quoted quantities, for example "0.8".<br/>
        </td>
        <td>true</td>
      </tr><tr>
        <td><b>isEnabled</b></td>
        <td>boolean</td>
        <td>
          Whether the evaluation is active.<br/>
          <br/>
            <i>Default</i>: true<br/>
        </td>
        <td>false</td>
...
<sup><sup>[↩ Parent](#aievaluationspec)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#aievaluationstatusconditionsindex">conditions</a></b></td>
        <td>[]object</td>
        <td>
          <br/>
        </td>
...
<sup><sup>[↩ Parent](#aievaluationstatus)</sup></sup>
...
<table>
    ...
    <tbody><tr>
      ...
      <td>true</td>
        ...
        <td><b><a href="#configurationgroupspec">spec</a></b></td>
        <td>object</td>
        <td>
          ConfigurationGroupSpec defines the desired state of a Fleet Manager configuration group.
This resource is in Beta and uses the Preview configuration-group API.<br/>
        </td>
        <td>false</td>
      </tr><tr>
        <td><b><a href="#configurationgroupstatus">status</a></b></td>
        <td>object</td>
        <td>
          ConfigurationGroupStatus defines the observed state of ConfigurationGroup.<br/>
        </td>
        <td>false</td>
      </tr></tbody>
</table>
...
### ConfigurationGroup.spec
<sup><sup>[↩ Parent](#configurationgroup)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#configurationgroupspecfamily">family</a></b></td>
        <td>object</td>
        <td>
        ...
        <td><b>priorityOrder</b></td>
        <td>integer</td>
        <td>
          Selection precedence. Higher values win on ties and 0 is the default.<br/>
          <br/>
            <i>Format</i>: int32<br/>
        </td>
        <td>false</td>
        ...
        <td>[]string</td>
        <td>
          Tags attached to the configuration group.<br/>
        </td>
        <td>false</td>
      </tr></tbody>
</table>
...
### ConfigurationGroup.spec.family
<sup><sup>[↩ Parent](#configurationgroupspec)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td>boolean</td>
        <td>
          Whether this family is active.<br/>
          <br/>
            <i>Default</i>: true<br/>
        </td>
        <td>false</td>
...
The replace API keeps the existing value when this field is omitted.<br/>
        ...
        <td>map[string]string</td>
        <td>
          Metadata stored with this configuration family.<br/>
        </td>
        <td>false</td>
      </tr></tbody>
</table>
...
<table>
    ...
    <tbody><tr>
        ...
        <td>string</td>
        <td>
          Remote configuration name.<br/>
        </td>
        <td>true</td>
      </tr><tr>
        <td><b>rawConfiguration</b></td>
        <td>string</td>
        <td>
          OpenTelemetry Collector configuration YAML. The supervisor-managed OpAMP extension must not be configured.<br/>
        </td>
        <td>true</td>
      </tr><tr>
        <td><b>agentSelector</b></td>
        <td>map[string]string</td>
        <td>
          Flat agent attributes that match agents for this configuration.<br/>
        </td>
        <td>false</td>
      </tr></tbody>
</table>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#configurationgroupstatusconditionsindex">conditions</a></b></td>
        <td>[]object</td>
        <td>
          <br/>
        </td>
...
### ConfigurationGroup.status.conditions[index]
<sup><sup>[↩ Parent](#configurationgroupstatus)</sup></sup>
...
mutually exclusive with per-target priority overrides.<br/>
        ...
        <td>[]enum</td>
        <td>
          The severities to apply the policy on. Mutually exclusive with dpxlExpression.<br/>
          <br/>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#tcotracespoliciesspecpoliciesindexpriorityoverride">priorityOverride</a></b></td>
        <td>object</td>
        <td>
          Dynamic quota-based priority override for the policy.<br/>
        </td>
...
### TCOTracesPolicies.spec.policies[index].priorityOverride
<sup><sup>[↩ Parent](#tcotracespoliciesspecpoliciesindex)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#tcotracespoliciesspecpoliciesindexpriorityoverridequotabased">quotaBased</a></b></td>
        <td>object</td>
        <td>
          TCOPolicyQuotaBased maps daily quota consumption percentages to priority levels.<br/>
        </td>
...
### TCOTracesPolicies.spec.policies[index].priorityOverride.quotaBased
<sup><sup>[↩ Parent](#tcotracespoliciesspecpoliciesindexpriorityoverride)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#tcotracespoliciesspecpoliciesindexpriorityoverridequotabasedusagetiersindex">usageTiers</a></b></td>
        <td>[]object</td>
        <td>
          <br/>
        </td>
...
### TCOTracesPolicies.spec.policies[index].priorityOverride.quotaBased.usageTiers[index]
<sup><sup>[↩ Parent](#tcotracespoliciesspecpoliciesindexpriorityoverridequotabased)</sup></sup>
