...
//+kubebuilder:webhook:path=/validate-coralogix-coralogix-com-v1alpha1-outboundwebhook,mutating=false,failurePolicy=fail,sideEffects=None,groups=coralogix.coralogix.com,resources=outboundwebhooks,verbs=create;update,versions=v1alpha1,name=voutboundwebhook.kb.io,admissionReviewVersions=v1
...
func (r *OutboundWebhook) ValidateCreate() (warnings admission.Warnings, err error) {
	//panic("implement me")
	outboundwebhooklog.Info("validate create", "name", r.Name)

	// TODO(user): fill in your validation logic upon object creation.
	return admission.Warnings{"this is a warning", "this is another warning"}, fmt.Errorf("this is an error")
}
