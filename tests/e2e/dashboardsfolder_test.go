...
var _ = Describe("DashboardsFolder", Ordered, func() {
    var (
        ...
        dashboardFolderName     = fmt.Sprintf("dashboards-foldersample-%d", time.Now().Unix())
    ...
    It("Should be created successfully", func(ctx context.Context) {
        ...
        dashboardsFolder = getSampleDashboardsFolder(dashboardFolderName)
    ...
    It("Should be updated successfully", func(ctx context.Context) {
        ...
        dashboardUpdatedFolderName := fmt.Sprintf("dashboards-foldersample-%d", time.Now().Unix())
        modifiedDashboardsFolder := getSampleDashboardsFolder(dashboardUpdatedFolderName)
