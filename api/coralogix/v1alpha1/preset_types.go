...
type PresetConnectorType struct {
	// +optional
	GenericHttps *PresetConnectorTypeGenericHttps `json:"genericHttps"`

	// +optional
	Slack *PresetConnectorTypeSlack `json:"slack"`
}

type PresetConnectorTypeGenericHttps struct {
	// +optional
	General *PresetConnectorTypeGenericHttpsGeneral `json:"general"`

	// +optional
	Overrides []PresetConnectorTypeGenericHttpsOverride `json:"overrides"`
}

type PresetConnectorTypeGenericHttpsGeneral struct {
	Fields *PresetConnectorTypeGenericHttpsFields `json:"fields"`
}

type PresetConnectorTypeGenericHttpsOverride struct {
	Fields *PresetConnectorTypeGenericHttpsFields `json:"fields"`

	EntitySubType string `json:"entitySubType"`
}

type PresetConnectorTypeGenericHttpsFields struct {
	// +optional
...
type PresetConnectorTypeSlack struct {
	// +optional
	General *PresetConnectorTypeSlackGeneral `json:"general"`

	// +optional
	Overrides []PresetConnectorTypeSlackOverride `json:"overrides"`
}

type PresetConnectorTypeSlackGeneral struct {
	// +optional
	RawFields *PresetConnectorTypeSlackRawFields `json:"rawFields"`

	// +optional
	StructuredFields *PresetConnectorTypeSlackStructuredFields `json:"structuredFields"`
}

type PresetConnectorTypeSlackOverride struct {
	// +optional
	RawFields *PresetConnectorTypeSlackRawFields `json:"rawFields"`
...
type PresetConnectorTypeSlackRawFields struct {
	Payload string `json:"payload"`
}

type PresetConnectorTypeSlackStructuredFields struct {
	// +optional
...
func getGenericHttpsConfigOverride(
	fields *PresetConnectorTypeGenericHttpsFields,
...
func getGenericHttpsMessageConfigFields(fields *PresetConnectorTypeGenericHttpsFields) []*cxsdk.MessageConfigField {
...
func getSlackConfigOverride(
	rawFields *PresetConnectorTypeSlackRawFields,
	structuredFields *PresetConnectorTypeSlackStructuredFields,
	entityType, entitySubType string,
) *cxsdk.ConfigOverrides {
...
func getSlackMessageConfigRawFields(fields *PresetConnectorTypeSlackRawFields) []*cxsdk.MessageConfigField {
...
func getSlackMessageConfigStructuredFields(fields *PresetConnectorTypeSlackStructuredFields) []*cxsdk.MessageConfigField {
	var msgConfigFields []*cxsdk.MessageConfigField
	if fields.Title != nil {
		msgConfigFields = append(msgConfigFields, &cxsdk.MessageConfigField{
