...
import (
	...
	"github.com/coralogix/coralogix-operator/api"
...
var (
	...
	severitiesV1beta1ToV1alpha1 = api.ReverseMap(severitiesV1alpha1ToV1beta1)
	...
	notifyOnV1beta1ToV1alpha1  = api.ReverseMap(notifyOnV1alpha1ToV1beta1)
	...
	severitiesFilterV1beta1ToV1alpha1 = api.ReverseMap(severitiesFilterV1alpha1ToV1beta1)
	...
	autoRetireRatioV1beta1ToV1alpha1 = api.ReverseMap(autoRetireRatioV1alpha1ToV1beta1)
	...
	logsTimeWindowV1beta1ToV1alpha     = api.ReverseMap(logsTimeWindowV1alpha1ToV1beta1)
	...
	logsConditionTypeV1beta1ToV1alpha = api.ReverseMap(logsConditionTypeV1alpha1ToV1beta1)
	flowOperationV1alpha1ToV1beta1    = map[FlowOperator]v1beta1.FlowStageGroupAlertsOp{
		"AND": v1beta1.FlowStageGroupAlertsOpAnd,
		"OR":  v1beta1.FlowStageGroupAlertsOpOr,
	}
	flowOperationV1beta1ToV1alpha     = api.ReverseMap(flowOperationV1alpha1ToV1beta1)
	...
	metricTimeWindowV1beta1ToV1alpha1    = api.ReverseMap(metricTimeWindowV1alpha1ToV1beta1)
	...
	metricConditionTypeV1beta1ToV1alpha1        = api.ReverseMap(metricConditionTypeV1alpha1ToV1beta1)
	metricAnomalyConditionTypeV1alpha1ToV1beta1 = map[PromqlAlertWhen]v1beta1.MetricAnomalyConditionType{
		PromqlAlertWhenLessThan:    v1beta1.MetricAnomalyConditionTypeLessThan,
		PromqlAlertWhenLessOrEqual: v1beta1.MetricAnomalyConditionTypeLessThan,
		PromqlAlertWhenMoreThan:    v1beta1.MetricAnomalyConditionTypeMoreThan,
		PromqlAlertWhenMoreOrEqual: v1beta1.MetricAnomalyConditionTypeMoreThan,
	}
	metricAnomalyConditionTypeV1beta1ToV1alpha1 = map[v1beta1.MetricAnomalyConditionType]PromqlAlertWhen{
		v1beta1.MetricAnomalyConditionTypeLessThan: PromqlAlertWhenLessThan,
		v1beta1.MetricAnomalyConditionTypeMoreThan: PromqlAlertWhenMoreThan,
	}
	...
	newValueTimeWindowV1beta1ToV1alpha = api.ReverseMap(newValueTimeWindowV1alpha1ToV1beta1)
	...
	tracingTimeWindowV1beta1ToV1alpha1   = api.ReverseMap(tracingTimeWindowV1alpha1ToV1beta1)
	...
	logsRatioTimeWindowV1beta1ToV1alpha1 = api.ReverseMap(logsRatioTimeWindowV1alpha1ToV1beta1)
	...
	ratioConditionTypeV1beta1ToV1alpha1     = api.ReverseMap(ratioConditionTypeV1alpha1ToV1beta1)
...
func (src *Alert) ConvertTo(dstRaw conversion.Hub) error {
	...
	dstSpec := v1beta1.AlertSpec{
		...
		TypeDefinition: convertAlertTypeV1alpha1ToV1beta1(src.Spec),
	}
...
func convertAlertTypeV1beta1ToV1alpha1(definition v1beta1.AlertTypeDefinition, groupBy []string) (*AlertType, []string) {
	if logsImmediate := definition.LogsImmediate; logsImmediate != nil {
		...
		return &AlertType{
			Tracing: convertTracingV1beta1ToV1alpha1(tracingThreshold, groupBy),
...
func convertTracingV1beta1ToV1alpha1(tracingThreshold *v1beta1.TracingThreshold, groupBy []string) *Tracing {
...
func convertLogsNewValueV1beta1ToV1alpha1(logsNewValue *v1beta1.LogsNewValue) *NewValue {
	...
	return &NewValue{
		Filters: logsFilterV1beta1ToV1alpha1(logsNewValue.LogsFilter),
...
func convertRatioV1beta1ToV1alpha1(logsRatioThreshold *v1beta1.LogsRatioThreshold, groupBy []string) *Ratio {
	...
	query1Filters := *logsFilterV1beta1ToV1alpha1(&logsRatioThreshold.Numerator)
...
func convertLogsThresholdV1beta1ToStandardV1alpha1(logsThreshold *v1beta1.LogsThreshold, groupBy []string) *Standard {
	...
	return &Standard{
		Filters: logsFilterV1beta1ToV1alpha1(logsThreshold.LogsFilter),
...
func convertLogImmediateV1beta1ToStandardV1alpha1(logsImmediate *v1beta1.LogsImmediate) *Standard {
	return &Standard{
		Filters: logsFilterV1beta1ToV1alpha1(logsImmediate.LogsFilter),
	}
}
...
func logsFilterV1beta1ToV1alpha1(filter *v1beta1.LogsFilter) *Filters {
	if filter == nil {
		return nil
	}
...
func convertAlertTypeV1alpha1ToV1beta1(srcSpec AlertSpec) v1beta1.AlertTypeDefinition {
	if standard := srcSpec.AlertType.Standard; standard != nil {
		if standard.Conditions.AlertWhen == StandardAlertWhenImmediately {
			return v1beta1.AlertTypeDefinition{
				LogsImmediate: &v1beta1.LogsImmediate{
					NotificationPayloadFilter: srcSpec.PayloadFilters,
		...
		if promql := metric.Promql; promql != nil {
			if promql.Conditions.AlertWhen == PromqlAlertWhenMoreThanUsual {
				return v1beta1.AlertTypeDefinition{
		...
		return v1beta1.AlertTypeDefinition{
			LogsUniqueCount: &v1beta1.LogsUniqueCount{
				...
				NotificationPayloadFilter:   srcSpec.PayloadFilters,
				MaxUniqueCountPerGroupByKey: pointer.Uint64(uint64(uniqueCount.Conditions.MaxUniqueValues)),
				UniqueCountKeypath:          uniqueCount.Conditions.Key,
				Rules: []v1beta1.LogsUniqueCountRule{
					convertUniqueCountConditionsV1alpha1ToV1beta1(uniqueCount.Conditions),
				},
			},
		}
	}
...
func convertToIntegrationTypeV1alpha1ToV1Beta1(notification Notification) v1beta1.IntegrationType {
	if notification.IntegrationName != nil {
		//TODO: Implement integration name conversion
	}
