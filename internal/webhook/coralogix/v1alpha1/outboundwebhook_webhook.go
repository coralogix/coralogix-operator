...
// +kubebuilder:webhook:path=/validate-coralogix-coralogix-com-v1alpha1-outboundwebhook,mutating=false,failurePolicy=fail,sideEffects=None,groups=coralogix.coralogix.com,resources=outboundwebhooks,verbs=create;update,versions=v1alpha1,name=voutboundwebhook-v1alpha1.kb.io,admissionReviewVersions=v1
