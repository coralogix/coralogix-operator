...
func validateGenericHttpsSubtypes(entityType string, genericHttps *coralogixv1alpha1.PresetGenericHttps) error {
...
func getInvalidSlackSubtypes(entityType string, slack *coralogixv1alpha1.PresetSlack) []string {
	var invalidSubtypes []string
