...
//func createRuleGroupClientSimpleMock(mockCtrl *gomock.Controller) mock_clientset.MockRuleGroupsClientInterface {
...
//func createRecordingRuleGroupClientSimpleMockWith5XXStatusError(mockCtrl *gomock.Controller) cxsdk.RuleGroupsClient {
//	mockRuleGroupsClient := mock_clientset.NewMockRuleGroupsClientInterface(mockCtrl)
//
